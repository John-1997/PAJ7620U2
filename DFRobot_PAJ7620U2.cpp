...
String DFRobot_PAJ7620U2::gestureCode(eGesture_t gesture)
{
    for(int i=0;i<sizeof(gestureCodesTable)/sizeof(gestureCodesTable[0]);i++){
        if(gesture == gestureCodesTable[i].gesture){
          return gestureCodesTable[i].code;
        }
    }
    return "";
}
...
const DFRobot_PAJ7620U2::sGestureCode_t DFRobot_PAJ7620U2::gestureCodesTable[]={
  {eGestureNone,0 },
  {eGestureRight, 32A6F807},
  {eGestureLeft, 32A67887},
  {eGestureUp, 32A6A857},
  {eGestureDown, 32A638C7},
  {eGestureForward, 32A6B04F},
  {eGestureBackward, 32A6B847},
  {eGestureClockwise, 32A6DA25},
  {eGestureAntiClockwise, 32A6CA35},
  {eGestureWave, 32A650AF},
};
